...
function addDeclarationTemplates (ctx: Unimport, options: Partial<AutoImportsOptions>) {
  const nuxt = useNuxt()
  ...
  addTemplate({
    ...
    getContents: () => '// Generated by auto imports\n' + (
      options.enabled
        ...
        : '// Auto importing is disabled, you can import from `#import` explicitly instead.'
    )
  })
}
